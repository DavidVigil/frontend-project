...
import {
  ...
  Typography,
  Grid2,
} from "@mui/material"; // Importing Grid2 correctly
...
const AppList = ({
  ...
  // Default value for userApps and new props
  ...
  const filteredApps = pseudoApps.filter(
    (app) =>
  ...
  return (
    ...
    >
        ...
        {filteredApps.map((app, index) => (
          ...
          >
            <Grid2 container spacing={2} alignItems="center">
              {" "}
              {/* Using Grid2 from @mui/material */}
              <Grid2 xs={12} sm={2}>
                {" "}
                {/* Correctly using Grid2's item property */}
                <ListItemAvatar>
                  <Avatar
                    src={app.logo}
                    sx={{
      ...
      >
        <DialogTitle sx={{ color: "text.title" }}>Save</DialogTitle>
        <DialogContent>
          <Typography sx={{ color: "text.subtitle" }}>
            You must sign in to do this action!
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button
      ...
      >
        ...
        <DialogContent>
          ...
          <Button onClick={() => handleFilterOptionClick("Extern")}>
            Extern
          </Button>
        </DialogContent>
        <DialogActions>
